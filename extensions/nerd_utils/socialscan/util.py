...
from .platforms import PlatformResponse, Platforms, QueryError
...
async def execute_queries(queries, platforms=None, proxy_list=None, aiohttp_session=None):
    ...
    Args:
        ...
        aiohttp_session (aiohttp 'ClientSession'): an aiohttp ClientSession to make requests with if provided, otherwise creates new one.
    ...
    checkers = init_checkers(aiohttp_session, platforms=platforms, proxy_list=proxy_list)
