...
from discord.ext.commands import Cog, Command, Context, DefaultHelpCommand as _DefaultHelpCommand, Group
...
class HelpCommand(_DefaultHelpCommand):
    ...
    async def send_bot_help(self, mapping: Mapping[Cog | None, list[Command]], /) -> None:
        ...
        grouped = groupby(filtered, key=get_category)
    ...
    async def send_cog_help(self, cog: Cog, /) -> None:
        ...
        embed.set_footer(
            text='Command argument syntaxes are shown: <arg> = required, [arg=DEFAULT] = optional (with a default value)')
